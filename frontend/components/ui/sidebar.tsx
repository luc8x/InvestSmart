...
function SidebarProvider({
  ...
  // Load initial state from cookie on client side
  React.useEffect(() => {
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "p-2 rounded-xl transition-all duration-300 border border-white/20",
